    ...
    return(
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <div className='w-px h-6 bg-zinc-800'/>
                ...
                <button onClick={openConfirmTripModal} className="bg-emerald-400 text-emerald-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-emerald-500">
                  Confirmar viagem
