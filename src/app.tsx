      ...
      {isGuestsModalOpen && (
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
            <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                  ...
                  {emailsToInvite.map(email =>{
                    return (
                      <div key={email} className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                        ...
                        <button onClick={() =>removeEmailFromIvites(email) } type='button'>
                ...
                <form onSubmit={addNewEmailOnInvite} className="p-2.5 bg-zinc-950 border border-l-zinc-800 rounded-lg flex items-center gap-2">
                  ...
                  <button type='submit' className="bg-emerald-400 text-emerald-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-emerald-500">
                    Convidar
